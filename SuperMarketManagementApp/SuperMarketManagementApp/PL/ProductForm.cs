        ...
        private void updatebtn_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                try
                {
                    ...
                    if (productModel.checkProductExistOrNot(productnametxt.Text)&&productModel.GetProductIdByName(productnametxt.Text)!= productId)
                    {
                        MessageBox.Show("This Product is Exist Before!");
                    }
                    else if (!productModel.checkProductExistOrNot(productnametxt.Text))
                    {
